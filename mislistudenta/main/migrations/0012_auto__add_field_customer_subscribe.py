...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.subscribe'
        db.add_column('main_customer', 'subscribe', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.subscribe'
        db.delete_column('main_customer', 'subscribe')
