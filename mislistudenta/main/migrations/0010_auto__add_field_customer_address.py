...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_customer', 'address', self.gf('django.db.models.fields.CharField')(default=u'', max_length=250), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.address'
        db.delete_column('main_customer', 'address')
