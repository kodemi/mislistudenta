...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.order_number'
        db.alter_column('main_order', 'order_number', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Order.order_number'
        db.alter_column('main_order', 'order_number', self.gf('django.db.models.fields.CharField')(max_length=6))
