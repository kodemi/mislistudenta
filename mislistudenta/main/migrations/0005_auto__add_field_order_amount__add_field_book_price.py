...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.amount'
        db.add_column('main_order', 'amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2), keep_default=False)

        # Adding field 'Book.price'
        db.add_column('main_book', 'price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.amount'
        db.delete_column('main_order', 'amount')

        # Deleting field 'Book.price'
        db.delete_column('main_book', 'price')
